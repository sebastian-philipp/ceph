...
import orchestrator
from orchestrator import OrchestratorError, HostSpec, OrchestratorValidationError, InventoryFilter
...
class CephadmOrchestrator(MgrModule, orchestrator.Orchestrator):
    ...
    def _prepare_deployment(self, all_hosts, drive_groups, inventory_list):
        # type: (List[orchestrator.InventoryNode], List[orchestrator.DriveGroupSpec], List[orchestrator.InventoryNode]) -> orchestrator.Completion
    ...
    def create_osds(self, drive_groups):
        # type: (List[orchestrator.DriveGroupSpec]) -> AsyncCompletion
