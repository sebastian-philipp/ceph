...
class RookEnv(object):
    def __init__(self):
        self.pod_namespace = os.environ['POD_NAMESPACE']
        self.cluster_name = os.environ.get('ROOK_CLUSTER_NAME', self.pod_namespace)
        self.system_ns = os.environ.get('ROOK_SYSTEM_NS', "rook-ceph-system")
        self.api_version = os.environ.get('ROOK_API_VERSION', 'v1')
        self.api_name = "ceph.rook.io/" + self.api_version
...
class RookOrchestrator(MgrModule, orchestrator.Orchestrator):
    ...
    def create_osds(self, drive_group, all_hosts):
        ...
        def is_complete():
            ...
            pod_osd_ids = set()
            pods = self._k8s.list_namespaced_pod(self._rook_env.pod_namespace,
