...
is sufficient, don't build your own wrapper. On the other hand, input
validation is the best place to catch errors and generate the best error
messages. If required, generate errors as soon as possible.
...
format::
    ...
    Status Code: 400
    {
        ...
        "controller": "rbd",  # this can be null to represent a global error code
...
+---------------------------------+-----------------------+-----------------------------------------------+
| Component                       | Code                  | Comment                                       |
+=================================+=======================+===============================================+
| ``rbd``                         | 1                     | Operation not permitted                       |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | 5                     | Input/output error                            |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | 16                    | Device or resource busy                       |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | 17                    | File exists                                   |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | 22                    | Invalid argument                              |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | 28                    | No space left on device                       |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | 30                    | Read-only file system                         |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | 33                    | Numerical argument out of domain              |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | 38                    | Function not implemented                      |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | 39                    | Directory not empty                           |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | 108                   | Cannot send after transport endpoint shutdown |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | 110                   | Connection timed out                          |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | 122                   | Disk quota exceeded                           |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | "ObjectNotFound"      | No such file or directory                     |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | "ObjectExists"        | Object already exists                         |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``rbd``                         | "LogicError"          | Invalid Argument                              |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``pool`` or ``osd`` or ``null`` | 1                     | Operation not permitted                       |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``pool`` or ``osd`` or ``null`` | 2                     | No such file or directory                     |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``pool`` or ``osd`` or ``null`` | 4                     | Interrupted system call                       |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``pool`` or ``osd`` or ``null`` | 5                     | Input/output error                            |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``pool`` or ``osd`` or ``null`` | 13                    | Permission denied                             |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``pool`` or ``osd`` or ``null`` | 16                    | Device or resource busy                       |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``pool`` or ``osd`` or ``null`` | 17                    | File exists                                   |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``pool`` or ``osd`` or ``null`` | 22                    | Invalid argument                              |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``pool`` or ``osd`` or ``null`` | 28                    | No space left on device                       |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``pool`` or ``osd`` or ``null`` | 61                    | No data available                             |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``pool`` or ``osd`` or ``null`` | 110                   | Connection timed out                          |
+---------------------------------+-----------------------+-----------------------------------------------+
| ``cephfs``                      | ``invalid_cephfs_id`` | Invalid cephfs id                             |
